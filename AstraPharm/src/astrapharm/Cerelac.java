 ...
 * @author SamHacker
 */
public class Cerelac extends javax.swing.JFrame {

    /**
     * Creates new form Home
     */
    String id;
    public Cerelac(String id) {
        initComponents();
        this.id=id;
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/astrapharm/Medicine Description Cerelac.png"))); // NOI18N
    ...
    private void cartMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cartMouseClicked
        ...
        int cerelac = (Integer) value;
        int trate = 750*cerelac;
        String med=value.toString()+"  :Cerelac 3 Fruit";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cerelac.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

 ...
 * @author SamHacker
 */
public class TootSiya extends javax.swing.JFrame {

    /**
     * Creates new form Home
     */
    String id;
    public TootSiya(String id) {
        initComponents();
        this.id=id;
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(mquantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 260, 100, 40));
        ...
        getContentPane().add(cart, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 260, 100, 40));
        ...
        getContentPane().add(buy, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 260, 110, 40));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/astrapharm/Medicine Description toot siyah.png"))); // NOI18N
    ...
    private void cartMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cartMouseClicked
        ...
        int toot = (Integer) value;
        int trate = 128*toot;
        String med=value.toString()+"  :TootSiya";
    ...
    private void buyMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buyMouseClicked
        // TODO add your handling code here:
        Object value = mquantity.getValue();
        int tsiya = (Integer) value;
        int trate = 128*tsiya;
        String med= " Toot Siya Syrup";
        DB_Model_AP db=new DB_Model_AP();
        try{
            int st=0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TootSiya.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

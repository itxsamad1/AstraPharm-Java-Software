 ...
 * @author SamHacker
 */
public class Arinac extends javax.swing.JFrame {

    /**
     * Creates new form Home
     */
    String id;
    public Arinac(String id) {
        initComponents();
        this.id=id;
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/astrapharm/Medicine Description Arinac.png"))); // NOI18N
    ...
    private void cartMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cartMouseClicked
        ...
        int arinac = (Integer) value;
        int trate = 116*arinac;
        String med= value.toString()+"  :Arinac";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Arinac.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

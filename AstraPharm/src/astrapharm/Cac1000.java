 ...
 * @author SamHacker
 */
public class Cac1000 extends javax.swing.JFrame {

    /**
     * Creates new form Home
     */
    String id;
    public Cac1000(String id) {
        initComponents();
        this.id=id;
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/astrapharm/Medicine Description Cac-100.png"))); // NOI18N
    ...
    private void cartMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cartMouseClicked
        ...
        int cac = (Integer) value;
        int trate = 210*cac;
        String med=value.toString()+"  :Cac-1000";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cac1000.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

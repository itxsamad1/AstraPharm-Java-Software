 ...
 * @author SamHacker
 */
public class Centrum extends javax.swing.JFrame {

    /**
     * Creates new form Home
     */
    String id;
    public Centrum(String id) {
        initComponents();
        this.id=id;
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/astrapharm/Medicine Description Centrum.png"))); // NOI18N
    ...
    private void cartMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cartMouseClicked
        ...
        int centrum = (Integer) value;
        int trate = 600*centrum;
        String med=value.toString()+"  :Centrum Silver";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Centrum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

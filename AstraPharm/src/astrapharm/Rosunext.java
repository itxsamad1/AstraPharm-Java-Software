 ...
 * @author SamHacker
 */
public class Rosunext extends javax.swing.JFrame {

    /**
     * Creates new form Home
     */
    String id;
    public Rosunext(String id) {
        initComponents();
        this.id=id;
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/astrapharm/Medicine Description Rousnext.png"))); // NOI18N
    ...
    private void cartMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cartMouseClicked
        ...
        int rosu = (Integer) value;
        int trate = 167*rosu;
        String med=value.toString()+"  :Rosunext";
    ...
    private void buyMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buyMouseClicked
        // TODO add your handling code here:
        Object value = mquantity.getValue();
        int rosunext = (Integer) value;
        int trate = 167*rosunext;
        String med= " Rosunext";
        DB_Model_AP db=new DB_Model_AP();
        try{
            int st=0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Rosunext.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

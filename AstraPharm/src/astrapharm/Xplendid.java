 ...
 * @author SamHacker
 */
public class Xplendid extends javax.swing.JFrame {

    /**
     * Creates new form Home
     */
    String id;
    public Xplendid(String id) {
        initComponents();
        this.id=id;
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/astrapharm/Medicine Description X-Plendid.png"))); // NOI18N
    ...
    private void cartMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cartMouseClicked
        ...
        int xplendid = (Integer) value;
        int trate = 168*xplendid;
        String med=value.toString()+"  :Xplendid";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Xplendid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

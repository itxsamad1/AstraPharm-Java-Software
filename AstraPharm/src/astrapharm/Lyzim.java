 ...
 * @author SamHacker
 */
public class Lyzim extends javax.swing.JFrame {

    /**
     * Creates new form Home
     */
    String id;
    public Lyzim(String id) {
        initComponents();
        this.id=id;
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/astrapharm/Medicine Description Lyzim.png"))); // NOI18N
    ...
    private void cartMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cartMouseClicked
        ...
        int lyzim = (Integer) value;
        int trate = 560*lyzim;
        String med=value.toString()+"  :Lyzim";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lyzim.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
